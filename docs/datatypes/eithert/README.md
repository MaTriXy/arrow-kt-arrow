...
lifted
//(kotlin.Int) -> arrow.effects.ObservableKW<arrow.core.Either<Line_2.BizError, arrow.core.Option<arrow.effects.ObservableKW<arrow.core.Either<Line_2.BizError, kotlin.String>>>>>
```
...
eitherTVal
//EitherT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@404ef630))
```
...
```kotlin
eitherTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@404ef630)
```
